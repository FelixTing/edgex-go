...
var (
	...
	unsupportedNotificationCategory            = "unsupportedCategory"
	unsupportedNotificationSeverity            = "unsupportedSeverity"
	unsupportedNotificationStatus              = "unsupportedStatus"
)
...
func TestAddNotification(t *testing.T) {
	...
	noCategory := requests.NewAddNotificationRequest(testAddNotificationRequest)
	noCategory.Notification.Category = ""
	invalidCategory := requests.NewAddNotificationRequest(testAddNotificationRequest)
	...
	tests := []struct {
		...
		{"invalid, no category", []requests.AddNotificationRequest{noCategory}, http.StatusBadRequest},
		{"invalid, unsupported category", []requests.AddNotificationRequest{invalidCategory}, http.StatusBadRequest},
